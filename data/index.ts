...
export const projects = [
  {
    id: 1,
    title: "Ezmed - Digital Medical Assistance",
    des: "Re-engineered the Apollo 24/7 app with firebase and flutter powered with AI and advanced ML model integrations",
    img: "/po1.svg",
  ...
  {
    id: 3,
    title: "Bizzspot - Elevate business beyond limits",
